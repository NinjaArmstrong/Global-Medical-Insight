...
export const articles: Article[] = [
  ...
  {
    id: "710",
    title: "【トルコ】MDR完全準拠とインフレ下の価格改定",
    region: "Middle East",
    date: "2025-12-10",
    riskLevel: "High",
    scenario: "トルコTITCKはEU MDRへの完全準拠を要求。一方で、インフレ率50%超に伴う公定価格（SUT）の改定遅延が、輸入・販売継続の重大なリスク要因となっている。",
    impact: "日系メーカー（テルモ、オムロン等）の利益圧迫およびMDR未対応製品の市場排除リスク。",
    action: "現地代理店との価格交渉を頻回に行い、MDR適合宣言書の早期提出および製品ポートフォリオの絞り込みをご検討ください。",
    url: "https://www.titck.gov.tr/"
  },
  // --- Designated Emerging Markets (Batch 8) ---
  {
    id: "801",
    title: "【エジプト】EDA 2026年：医療機器輸入規制と現地化優遇",
    region: "Africa",
    date: "2026-01-05",
    riskLevel: "Medium",
    scenario: "エジプト医薬品庁（EDA）は2026年より輸入承認ガイドラインを厳格化（原産国証明の不一致解消等）。一方で、現地組立（SKD/CKD）を行う企業には迅速審査や公共入札での価格優遇（15%）を提供する「投資家サポートサービス」を強化。",
    impact: "現地生産パートナーを持たない日系メーカー（シスメックス、日本光電等）の公共入札競争力低下。",
    action: "現地代理店を通じたSKD（セミノックダウン）生産の可能性を調査し、政府の現地化インセンティブを活用する戦略をご検討ください。",
    url: "https://www.edaegypt.gov.eg/"
  },
  {
    id: "802",
    title: "【モロッコ】AMO（強制医療保険）2026年完全統合",
    region: "Africa",
    date: "2025-12-20",
    riskLevel: "Low",
    scenario: "モロッコは2026年1月より、全公的保険制度をCNSS（国家社会保障基金）へ統合し、国民皆保険（AMO）を実質完成させる。これにより約2,200万人の追加被保険者が発生し、診断・治療機器の需要が急増する見込み。",
    impact: "公立・私立病院双方での画像診断装置（キヤノン、富士フイルム）および検体検査機器の需要拡大。",
    action: "CNSSの償還リストへの製品登録状況を再確認し、新設クリニック向けのパッケージ提案を強化することをお勧めいたします。",
    url: "https://www.cnss.ma/"
  },
  {
    id: "803",
    title: "【ナイジェリア】NAFDAC 2026規制と為替危機の影響",
    region: "Africa",
    date: "2026-01-08",
    riskLevel: "High",
    scenario: "NAFDACは「医療機器規制2025」を施行し、リスク分類（Class A-D）に基づく登録審査を厳格化。一方で、ナイラ安による輸入コスト増は継続しており、大統領令による一部医療品へのVAT/関税免除措置の適用範囲が焦点となっている。",
    impact: "日系企業の輸出採算性悪化および新規登録の遅延リスク（承認まで12ヶ月以上）。",
    action: "現地ディストリビューターの在庫・資金繰り状況を密にモニタリングし、LC（信用状）条件の厳格化や前払い条件の適用をご検討ください。",
    url: "https://www.nafdac.gov.ng/"
  },
  {
    id: "804",
    title: "【ケニア】デジタルヘルス・スーパーハイウェイ 2026",
    region: "Africa",
    date: "2026-01-06",
    riskLevel: "Medium",
    scenario: "ケニア政府はSafaricom等のコンソーシアムと提携し、2026年にかけて「統合医療情報システム（IHTS）」を全国展開。公的医療機関への納入には、サプライチェーン管理システムとのAPI連携やデジタルタグ対応が必須要件となる。",
    impact: "デジタル対応が遅れている医療機器・消耗品メーカーの入札参加資格喪失リスク。",
    action: "現地ITパートナーを選定し、貴社製品の在庫管理・トラッキングシステムがIHTSの技術仕様に適合するか確認作業を進めることを推奨します。",
    url: "https://www.health.go.ke/"
  },
  {
    id: "805",
    title: "【南アフリカ】SAHPRA デジタル登録制度の本格稼働",
    region: "Africa",
    date: "2025-11-15",
    riskLevel: "Medium",
    scenario: "SAHPRA（南ア健康製品規制当局）は2026年初頭より、臨床試験および医療機器登録の完全デジタル化（eCTD形式）を開始。NHI（国民健康保険）法案の第2フェーズ移行に伴い、価格統制と製品選定の集約化が進む。",
    impact: "登録プロセスの透明性は向上するが、NHI対象品目の価格引き下げ圧力（日立、島津製作所等への影響）。",
    action: "eCTD形式へのデータ移行を早期に完了させ、NHI入札に向けたコスト競争力の見直しと現地B-BBEEパートナーとの連携強化をご検討ください。",
    url: "https://www.sahpra.org.za/"
  },
  {
    id: "806",
    title: "【サウジアラビア】NUPCO 2026：・現地化要件の厳格化",
    region: "Middle East",
    date: "2025-12-05",
    riskLevel: "High",
    scenario: "NUPCO（国立医薬品統一調達公社）は2026年度の入札より、「Made in Saudi」製品が存在する場合、海外製品の調達を制限する方針を強化。Seha Virtual Hospital等の国家プロジェクトでも、AI・デジタル機器の現地サーバー要件が課される。",
    impact: "輸出のみに依存する日系医療機器メーカーのシェア喪失リスク。特に消耗品分野。",
    action: "サウジ国内での委託製造（CDMO）または現地組立拠点の設立可能性について、早急にFS（フィージビリティスタディ）を実施することをお勧めします。",
    url: "https://www.nupco.com/"
  },
  {
    id: "807",
    title: "【UAE】2026年 医療専門職・AIライセンス統合プラットフォーム",
    region: "Middle East",
    date: "2026-01-07",
    riskLevel: "Low",
    scenario: "UAE保健予防省は2026年Q2に、医療従事者およびAI医療機器のライセンスを連邦レベルで統合するデジタルプラットフォームを稼働。ドバイ・アブダビ間の規制差異が解消され、AI搭載機器の市場投入スピードが向上する。",
    impact: "AI診断支援システム（オリンパス、富士フイルム）のUAE全土への展開加速。",
    action: "連邦統合ライセンスの要件を確認し、AI機能を含む製品の承認申請を一括で行うための準備を進めることを推奨します。",
    url: "https://mohap.gov.ae/"
  },
  {
    id: "808",
    title: "【パキスタン】DRAP登録遅延と輸入LC危機の継続",
    region: "South Asia",
    date: "2026-01-04",
    riskLevel: "High",
    scenario: "DRAP（パキスタン度量衡局）の登録審査バックログと、2025年末の未登録品輸入免除期限切れにより、主要港での通関遅延が深刻化。外貨不足によるLC（信用状）開設遅延も依然として解決していない。",
    impact: "日系企業の製品が港湾で滞留し、デマレージ（滞船料）発生や市場欠品のリスク。",
    action: "船積み前の全額入金（T/T）を原則とし、DRAP登録証の有効期限確認と更新手続きを最優先で行うよう現地代理店に指示することをご検討ください。",
    url: "https://www.dra.gov.pk/"
  },
  {
    id: "809",
    title: "【インド】CDSCO クラスC/D ライセンス完全義務化",
    region: "South Asia",
    date: "2025-11-25",
    riskLevel: "High",
    scenario: "数度の延期を経て、CDSCOはクラスC/D（中〜高リスク）医療機器の製造・輸入ライセンスの完全義務化を徹底。2025年11月以降、公的調達においてはライセンス未取得製品の入札参加が完全に排除される。",
    impact: "申請中の日系メーカー（テルモ、朝日インテック等）の販売一時停止リスク。",
    action: "申請状況（クエリ回答待ち等）を即座に確認し、必要であれば現地コンサルタントを起用して承認取得を加速させることを強く推奨します。",
    url: "https://cdsco.gov.in/"
  },
  {
    id: "810",
    title: "【フィリピン】FDA デジタル化とASEAN医療機器指令準拠",
    region: "SE Asia",
    date: "2026-01-08",
    riskLevel: "Medium",
    scenario: "フィリピンFDAは「eServices Portal」の適用範囲を全クラス（A-D）に拡大し、ASEAN医療機器指令（AMDD）への完全準拠を2026年内に達成する方針。他ASEAN諸国での承認を活用した簡易審査ルートも整備される。",
